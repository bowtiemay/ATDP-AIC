...
<body>
  ...
  <form action="printout.php" method="post">
    ...
    <h3>Welcome! Please begin by filling out the following information:</h3>
    ...
    <div id="bioinfo">
      ...
      <label for="gender"><h3>What is your gender?</h3></label>
        ...
        <br>
        <input type="radio" id="nonbinary" name="gender" value="intersex">
        <label for="gender">Nonbinary</label>
        <br>
        ...
        <p>Enter your birthday:</p>
         <input type="number" name="mdate" min="1" max="12" placeholder="M" required="required">
         <input type="number" name="ddate" min="1" max="31" placeholder="D" required="required">
         <input type="number" name="ydate" min="1921" max="2021" placeholder="Y" required="required">
      ...
      <h3>Thanks for filling out the intro questions! Now for some fun. I officially welcome you to the quiz of overly invasive questions. Apologies in advance.</h3>
      <br>
